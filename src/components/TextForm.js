...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'black'}}> 
            ...
            <div className="mb-3"> 
            <textarea className="form-control" value={text} onChange={handleOnChange} style={{backgroundColor: props.mode==='dark'?'#454545':'white', color: props.mode==='dark'?'white':'#454545'}} id="myBox" rows="8"></textarea>
            </div>
        ...
        <div className="container my-3" style={{color: props.mode==='dark'?'white':'#454545'}}>
